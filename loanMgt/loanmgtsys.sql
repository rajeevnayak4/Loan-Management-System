...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2021 at 09:49 AM
...
INSERT INTO `data` (`id`, `name`, `location`, `email`, `mobile`, `amount`) VALUES
(18, 'sulav', 'lalitpur', 'sulav@gmail.com', 7856745, 0),
(19, 'Musical Instrument', 'Location', 'admin@cartmandoo.com', 54335, 100);
...
INSERT INTO `investor_tb` (`id`, `name`, `location`, `investment_type`, `interest_rate`, `amount`) VALUES
(2, 'sulav', 'lalitpur', 'saving', 6, 0),
(3, 'All', 'Address', 'current', 22, 0),
(7, 'sdfsf', 'fds', 'fdsfds', 5364, 0),
(8, 'All', 'das', 'saving', 90, 0);
